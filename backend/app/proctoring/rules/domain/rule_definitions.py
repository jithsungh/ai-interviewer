...
DEFAULT_RULES: Final[tuple[ProctoringRule, ...]] = (
    ...
    ProctoringRule("screen_recording_uploaded", "low", 0.0, "Screen recording uploaded successfully"),
    ProctoringRule("screen_share_off_time", "low", 0.0, "Screen sharing inactive between segments"),
